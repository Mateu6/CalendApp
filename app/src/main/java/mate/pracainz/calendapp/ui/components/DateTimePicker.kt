    ...
    Column(
        ...
        DatePicker(
            state = rememberDatePickerState(
                initialSelectedDateMillis = selectedDate.year.toLong(),
                initialDisplayedMonthMillis = selectedDate.monthValue.toLong(),
        ...
        Row(
            ...
            Button(onClick = { onDateTimeChange(LocalDateTime.of(selectedDate, selectedTime)) }) {
                Text("OK")
            }
        }
    }
